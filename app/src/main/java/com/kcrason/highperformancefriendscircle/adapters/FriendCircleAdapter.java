...
public class FriendCircleAdapter extends RecyclerView.Adapter<FriendCircleAdapter.BaseFriendCircleViewHolder>
    ...
    public BaseFriendCircleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == Constants.FriendCircleType.HEADER_VIEW) {
            return new HeaderViewHolder(mLayoutInflater.inflate(R.layout.item_chat_moment_header, parent, false));
    ...
    public int getItemViewType(int position) {
        if (position == 0) {
            return Constants.FriendCircleType.HEADER_VIEW;
        } else {
    ...
    public int getItemCount() {
        return mFriendCircleBeans == null ? 1 : mFriendCircleBeans.size() + 1;
    }
    ...
    @Override
    public void onItemClickTranslation(int pos) {
    ...
    @Override
    public void onItemClickHideTranslation(int pos) {
        final int position = pos;
        if (mFriendCircleBeans != null && position < mFriendCircleBeans.size()) {
    ...
    private void updateTargetItemContent(int pos, BaseFriendCircleViewHolder baseFriendCircleViewHolder,
    ...
    private void notifyTargetItemView(int pos, TranslationState translationState, SpannableStringBuilder translationResult) {
        final int position = pos;
    ...
    @Override
    public void onItemClickCollection(int pos) {
        final int position = pos;
    ...
    static class HeaderViewHolder extends BaseFriendCircleViewHolder {
