...
public class Constants {
    ...
    public final static class FriendCircleType {
        ...
        public final static int FRIEND_CIRCLE_TYPE_ONLY_WORD = 1;
        //文字和图片
        public final static int FRIEND_CIRCLE_TYPE_WORD_AND_IMAGES = 2;
        //分享链接
        public final static int FRIEND_CIRCLE_TYPE_WORD_AND_URL = 3;
    }
